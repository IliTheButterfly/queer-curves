<script lang="ts">
	...
	function render(el: SVGSVGElement, g: SpectrumGraph) {
		...
		// 2D / 3D rendering will land in follow-up commits — see data_model.md §3.5.
		...
		// Waypoints — labeled guide lines along the spectrum axis.
		...
		// Endpoint labels alongside the y-axis.
		inner
			.append('text')
			.attr('x', -8)
			.attr('y', ih)
		...
		// Trajectory line + datapoint marks.
...
<svg bind:this={svgEl} viewBox="0 0 800 400" preserveAspectRatio="xMidYMid meet"></svg>
